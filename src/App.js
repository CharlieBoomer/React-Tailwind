...
<body>
    ...
    <nav className="relative container mx-auto p-6">
      ...
      <div className="md:hidden">
        <div
          id="menu"
        className={open?"absolute flex flex-col items-center self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md" :"absolute flex-col items-center hidden self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md"}
        >
          <a href="#">Pricing</a>
          <a href="#">Product</a>
          <a href="#">About Us</a>
    ...
    <section id="testimonials">
      ...
      <div className="max-w-6xl px-5 mx-auto mt-32 text-center">
        ...
        <div className="flex flex-col mt-24 md:flex-row md:space-x-6">
          ...
          >
            <img src={require("./components/assets/avatar-ali.png")} className="w-16 -mt-14" alt="" />
          ...
          <div
            className="hidden flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:flex md:w-1/3"
          >
            <img src={require("./components/assets/avatar-richard.png")} className="w-16 -mt-14" alt="" />
